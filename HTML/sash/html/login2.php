...
<head>
    ...
    <meta name="description" content="Sash – Bootstrap 5 Admin & Dashboard
            Template" />
    <meta name="author" content="Spruko Technologies Private Limited" />
    <meta name="keywords" content="admin,admin dashboard,admin panel,admin
            template,bootstrap,clean,dashboard,flat,jquery,modern,responsive,premium
            admin templates,responsive admin,ui,ui kit." />
    <!-- FAVICON -->
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        ...
        <div class="main-container container">
            <div class="row">
                <div class="col-md-12">
                    <div class="main-head d-flex justify-content-center align-items-center"></div>
                </div>
            </div>
            <!--Row -->
            <div class="row">
                            ...
                            <div id="wizard2">
                                ...
                                <section>
                                    ...
                                    <div class="form-group wd-xs-300">
                                        ...
                                        <input class="form-control" id="email" name="email" placeholder="Enter email address" required="" type="email" autocomplete="new-password" />
                                    </div>
                                </section>
                            ...
                            <ul class="task-list timeline-task">
                                ...
                                <li class="d-sm-flex">
                                    <div>
                                        ...
                                        <h6 class="fw-semibold">
                                            New Comment
                                            <span class="text-muted fs-11 mx-2 fw-normal">05 July 2021</span>
                                        </h6>
                                        <p class="text-muted fs-12">
                                ...
                                <li class="d-sm-flex">
                                    <div>
                                        ...
                                        <h6 class="fw-semibold">
                                            New Comment
                                            <span class="text-muted fs-11 mx-2 fw-normal">25 June 2021</span>
                                        </h6>
                                        <p class="text-muted fs-12">
                                            Victoria commented on Project
                                            <a href="javascript:void(0)" class="fw-semibold">
                                ...
                                <li class="d-sm-flex">
                                    <div>
                                        ...
                                        <h6 class="fw-semibold">
                                            Task Overdue
                                            <span class="text-muted fs-11 mx-2 fw-normal">14 June 2021</span>
                                        </h6>
                                ...
                                <li class="d-sm-flex">
                                    <div>
                                        ...
                                        <h6 class="fw-semibold">
                                            Task Overdue
                                            <span class="text-muted fs-11 mx-2 fw-normal">29 June 2021</span>
                                        </h6>
                                        <p class="text-muted mb-0 fs-12">
                                            Petey Cruiser finished task
                                            <a href="javascript:void(0)" class="fw-semibold">
                    ...
                    <div class="modal-body">
                        <ul class="row p-3">
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector">
                                        <img alt="" src="../assets/images/flags/russia_flag.jpg"
                                            class="me-3 language" />
                                    </span>
                                    Russia
                                </a>
